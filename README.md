...
<code>The purpose of this homelab is to learn more and apply the knowledge about managing kubernetes services locally.
...
- [X] **`Task 4`**: <strike>Azure Key Vault integration.</strike>
